      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-3">
        ...
        <div className="flex items-center justify-between sm:justify-end space-x-2">
          ...
          {activeUser ? (
                ...
                <div className="absolute right-0 mt-2 w-64 rounded-xl bg-slate-800 border border-slate-700 shadow-2xl p-2 z-50 animate-in fade-in slide-in-from-top-2 duration-150">
                  ...
                  <div className="border-t border-slate-700/80 mt-2 pt-2 space-y-1">
                    ...
                    >
                      ...
                      <span>Cambiar cuenta / Login</span>
                    </button>
                    <button
                      onClick={() => {
                        setUserDropdownOpen(false);
                      ...
                      className="w-full text-left px-3 py-1.5 rounded-lg text-xs text-rose-400 hover:bg-rose-950/50 flex items-center space-x-2 font-medium transition-colors"
                    >
            ...
            <button
              onClick={onOpenLogin}
              className="flex items-center space-x-1.5 px-3 py-1.5 rounded-lg bg-indigo-600 hover:bg-indigo-500 text-white text-xs font-semibold shadow transition-all"
            >
